...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://zspomwjvvwtpdc:415e809b7b6fa439205ad6e1401c46a6072031f150b9c50c15d130c3c23dd2e6@ec2-44-199-143-43.compute-1.amazonaws.com:5432/d6482m5rku85n3'
...
def create_todo():
    ...
    return make_response(jsonify({"todo": result}), 201)
